const VARIANT_STYLES = {
  primary:
    'border-transparent bg-gradient-to-r from-primary to-primaryStrong text-white hover:-translate-y-0.5 hover:scale-[1.01]',
  secondary:
    'border border-border bg-white/35 text-primary hover:-translate-y-0.5 hover:scale-[1.01] hover:bg-white/60',
  soft:
    'border border-transparent bg-white/80 text-ink hover:-translate-y-0.5 hover:scale-[1.01] hover:bg-white',
};
...
const BASE_STYLES =
  'btn-chamfer inline-flex w-full items-center justify-center gap-2 border font-heading font-semibold leading-none tracking-tight ' +
